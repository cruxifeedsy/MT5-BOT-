...
async def scan_markets(context: ContextTypes.DEFAULT_TYPE):
    ...
    for pair in PAIRS:
        ...
        if price < support:
            ...
            analysis = "Support broken with strong bearish pressure. Momentum expanding."
        ...
        if price > resistance:
            ...
            analysis = "Resistance breakout confirmed. Buyers showing strong dominance."
...
async def menu_handler(update: Update, context):
    ...
    if query.data == "ai":
        await query.edit_message_text("🤖 AI adds confidence scoring & filters weak trades")
